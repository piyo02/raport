...
class Pdf extends Teacher_Controller
{
	private $services = null;
	private $name = null;
	private $parent_page = 'teacher';
	private $current_page = 'teacher/pdf/';
	...
	public function export_raport($id)
	{
		// $this->load->view('teacher/export/raport');
		redirect(site_url('teacher/assessment'));

		// $this->load->library('pdf');
		// $this->pdf->load_view('teacher/export/raport');
		// $this->pdf->render();
